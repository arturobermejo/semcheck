...
// exported function with its doc comment, a log call, a test function), and
// a judge answers a closed natural-language question about each one with a
// calibrated probability. Only findings above the rule's confidence threshold
// are reported.
//
